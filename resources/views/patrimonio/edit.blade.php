                    ...
                    <form method="POST" action="{{ route('patrimonio.update', $patrimonio->id) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="item" name="item" type="text" class="mt-1 block w-full"
                                :value="old('item', $patrimonio->item)" placeholder="Ex: Barraca Iglu 4 Pessoas, Caixa de Som..." required
                                autofocus />
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    <x-text-input id="quantidade" name="quantidade" type="number" min="1"
                                        step="1" class="block w-full pl-4" :value="old('quantidade', $patrimonio->quantidade)" required />
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <x-text-input id="valor_estimado" name="valor_estimado" type="number"
                                        step="0.01" min="0" class="block w-full pl-10" :value="old('valor_estimado', $patrimonio->valor_estimado)"
                                        placeholder="0,00" />
                                </div>
                                ...
                                <x-text-input id="data_aquisicao" name="data_aquisicao" type="date"
                                    class="mt-1 block w-full" :value="old(
                                        ...
                                        $patrimonio->data_aquisicao
                                            ? \Carbon\Carbon::parse($patrimonio->data_aquisicao)->format('Y-m-d')
                                            : '',
                                    )" />
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                <x-text-input id="local_armazenamento" name="local_armazenamento" type="text"
                                    class="block w-full pl-10" :value="old('local_armazenamento', $patrimonio->local_armazenamento)"
                        ...
                        <div>
                            ...
                            <textarea id="observacoes" name="observacoes" rows="3"
                                ...
                                placeholder="Descreva detalhes específicos, número de série, cor, ou avarias existentes...">{{ old('observacoes', $patrimonio->observacoes) }}</textarea>
